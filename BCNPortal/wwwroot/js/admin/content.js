...
function initDataTable() {
    ...
    contentTable = $("#content-table").DataTable({
        ...
        order: [[1, "asc"]],
        ajax: {
            "url": "/Admin/Content/LoadContents",
            "type": "POST",
            "dataType": "JSON"
        },
        columns: [
            ...
            
            {
                ...
                "render": function (data, type, full, meta) {
                    return `<a href='/Admin/Content/Edit?contentId=${full.Id}'>${data}</a>`;
                }
            },
    ...
    $("#content-table").dataTable().fnFilterOnReturn();
...
function deleteSelection() {
    ...
    if (selection.length > 0)
        $.ajax({
            type: "POST",
            url: "/Admin/Content/DeleteRange",
            data: { contentIds: selection }
...
function LoadNotifications(succRemoveContent, succUpdateContent, succAddContent) {
    if (succRemoveContent === "True") {
        Lobibox.notify("info", {
            ...
            sound: false,
            title: "Info",
            msg: "Selected content has been deleted."
        });
    }
        ...
        Lobibox.notify("info", {
            ...
            sound: false,
            title: "Info",
            msg: "This content has been updated."
        });
    }
        ...
        Lobibox.notify("info", {
            ...
            sound: false,
            title: "Info",
            msg: "A new content has been created."
        });
    }
}