    ...
    var LobiboxBase = {
        ...
        _createMarkup: function () {
            ...
            if (me.$options.buttons && !$.isEmptyObject(me.$options.buttons)) {
                ...
                //Aqu? los botones
                if (me.$options.showButtons === true) {
    ...
    LobiboxPrompt.prototype = $.extend({}, LobiboxBase, {
        ...
        _createInput: function () {
            ...
            if (me.$options.multiline) {
                ...
                me.$input = $(`<input type="${me.$promptType}" maxlength=16 onkeypress="return isNumberKey(event)"/>`);
            }
...
//------------------------------------------------------------------------------
        ...
        var _createNotify = function () {
            ...
            if (me.$options.img) {
                ...
                $innerIconEl.append('<div class="icon-el"><i style="font-size:42px" class="' + me.$options.icon + '"></i></div>');
            } else {
...
//------------------------------------------------------------------------------
    ...
    Lobibox.notify.DEFAULTS = {
        ...
        messageHeight: 160,          // Notification message maximum height. This is not for notification itself, this is for <code>.lobibox-notify-msg</code>
